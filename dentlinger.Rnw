...
Peak sea turtle stranding months during 2010-2019 in the Gulf of Mexico were also in the spring to summer (March to August) \citep{howell2021}.
...
The relatively even distribution of turtles that stranded alive (\Sexpr{sum(side_status_table$A)}) versus dead \Sexpr{sum(side_status_table$D)} on \Hawaii\ Island in the present study is markedly different from the findings of \cite{chaloupka2008cause}, where on \Oahu, Maui, and Kauai approximately 75\% of green turtles stranded dead. 
