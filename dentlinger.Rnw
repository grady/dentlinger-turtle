...
\author[1,5]{\fnm{Skylar} \sur{Dentlinger}}
...
\affil[5]{Present address: \orgdiv{Rosenstiel School of Marine and Atmospheric Science}, \orgname{University of Miami}, \orgaddress{\city{Miami}, \state{Florida}, \postcode{33149}, \country{USA}.}}
...
Statistical modeling failed to provide convincing evidence of temporal changes in the distribution of strandings across three consolidated cause categories: human-caused; predation, disease, and weather; and unknown.
...
Of the \Sexpr{Ntot} stranded turtles in the records, slightly over half had no known cause that could be determined (the ``unknown'' cause).
