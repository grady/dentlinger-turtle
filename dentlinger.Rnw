...
\Hawaii\  Island, because of its large size (over half of the total land area in Hawaii), southernmost location, lowest human population density, and important turtle foraging and resting areas---recently proposed as critical habitat by the US Fish and Wildlife Service and the National Oceanic and Atmospheric Administration \citep{fed2023designation, fed2023proposed}---, merits additional scientific scrutiny of its green turtle stranding patterns with the most up-to-date, inclusive data available.
