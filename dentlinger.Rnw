...
\orgaddress{\city{Kamuela}, \state{Hawaii}, \postcode{96743}, \country{USA}. E-mail: {laurajim@hpa.edu}}}
...
We would like to thank the following individuals, agencies, and organizations that contributed to data collection, data availability, and/or mentorship:
Summer Martin, 
Brittany Clemans, 
